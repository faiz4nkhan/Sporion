...
class ResultPage extends StatefulWidget {
  ...
  ResultPage({required this.isLoggedIn, required this.isAdmin});
  ...
  void _updateMatchDetails() {
    if (widget.isAdmin) {
      final matchData = {
        'teamAName': teamANameController.text,
        'teamBName': teamBNameController.text,
        'teamAScore': teamAScoreController.text,
        'teamBScore': teamBScoreController.text,
        'gamestype':gametypeController.text
    };
          ...
          content: Column(
            ...
            children: [
              ...
              TextField(
                ...
                keyboardType: TextInputType.number,
                decoration: InputDecoration(labelText: 'MatchType(eg: cricket,vollyball..)'),
              ),
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              title: Text('${match['teamAName']} vs ${match['teamBName']}'),
              subtitle: Text('Score: ${match['teamAScore']} - ${match['teamBScore']} and Winner: ${match['winners']}'),
              trailing: widget.isAdmin
                  ? IconButton(
                icon: Icon(Icons.delete, color: Colors.red),
                onPressed: () {
